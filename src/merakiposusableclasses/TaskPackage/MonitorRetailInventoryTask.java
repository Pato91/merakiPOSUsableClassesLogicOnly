 ...
 * @author meraki
 */
public class MonitorRetailInventoryTask extends Task<JSONObject> {
    ...
    protected JSONObject call() throws ClassNotFoundException, JSONException {
        ...
        selectInventoryItems.put("Values", merakiBusinessDBClass.processSQLSelect(QueryBuilder.getRetailItems()));
