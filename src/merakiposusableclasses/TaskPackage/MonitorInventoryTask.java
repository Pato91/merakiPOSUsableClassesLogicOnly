 ...
 * @author meraki
 */
public class MonitorInventoryTask extends Task<JSONObject>{
    ...
    protected JSONObject call() throws ClassNotFoundException, JSONException {
        ...
        selectInventoryItems.put("Values", merakiBusinessDBClass.processSQLSelect(QueryBuilder.getRemInventoryItems()));
