 ...
 * @author meraki
 */
public class MonitorWhlSlInventoryTask extends Task<JSONObject> {
    ...
    protected JSONObject call() throws ClassNotFoundException, JSONException {
        ...
        selectInventoryItems.put("Values", merakiBusinessDBClass.processSQLSelect(QueryBuilder.getRemWhlSlInventoryItems()));
